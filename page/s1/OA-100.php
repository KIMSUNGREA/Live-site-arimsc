...
<input type="hidden" name="model" value="OA-100">
        <dl>
            <dt>이름</dt>
...
<iframe name="rt_ifrm" id="rt_ifrm" style="width:100%;height:700px;display:none;"></iframe>
        ...
        <section class="cont1">
            <div class="sub_wrap">
                <div class="tit_box" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                    <h2>환경부 성능 인증 1등급</h2>
                    <p>ArimAir <b>OA100</b></p>
                </div>
                <figure class="fig_box">
                    <img src="/assets/images/OA_100.png" class="img_ab oa_100" alt="">
                </figure>
                <ul class="epl pc" data-aos="fade-up" data-aos-duration="3000">
                    ...
                    <li>초미세먼지 포함 대기유해물질 4종 및 온도, 습도 기본 측정</li>
        ...
        <section class="cont2">
            <div class="sub_wrap">
                <ul class="tit_list">
					...
					<?php
					$_t = $dbo->fetch("SELECT COUNT(seq) AS cnt FROM RT_RTBOARD_NORM WHERE bcode='review' AND pdt_model='OA100' AND auth_en='y'");
					?>
                    <li>
        ...
        <section class="cont3"></section>
            <div class="sub_wrap no_padding">
                <div class="item_img_box">
                    <figure>
                        <img src="/assets/images/OA_100_sub.png" alt="">
                    </figure>
                    <figcaption class="oa_100">
                        <h3>좋은 공기를 위한 솔루션! 아림에어</h3>
                        <p>공기 속 보이지 않는 유해물질 아림에어가 보여드리겠습니다.</p>
                    </figcaption>
                </div>
                <div class="item_spec oa_100">
                    <img src="/assets/images/OA_100_s.png" alt="" data-aos="fade-up" data-aos-duration="3000">
                    <h4 data-aos="fade-up" data-aos-duration="3000" data-aos-delay="500">ArimAir <b>OA100</b></h4>
                    <p data-aos="fade-up" data-aos-duration="3000" data-aos-delay="1000">
                        심각한 대기오염, 솔루션이 필요합니다.<br>
			아파트, 실외, 놀이터 등 지금 숨쉬고있는 대기상태가 어떤지 실시간으로 확인하십시오.<br>
                        <b>초미세먼지, 오존, 이산화질소, 이산화황, 온 · 습도를 측정하여 실시간 대기상태를<br>
			전용 모니터링 웹사이트에서 확인할 수 있습니다.
			</b>
                    </p>
                </div>
		<div class="sub_wrap">
                <div class="point">
                    ...
                    <p data-aos="fade-up" data-aos-duration="3000">
                        OA100은 <b>초미세먼지, 오존, 이산화질소, 이산화황,</b> 온·습도까지<br class="pc"> 
                        실외 공기 정보를 동시에 측정하는 실외용 측정기 입니다.
                    </p>
                    <dl>
                        <dt data-aos="fade-right" data-aos-easing="ease-in-sine"><img src="/assets/images/OA_100_list1.png" alt=""></dt>
                ...
                <div class="point">
                    ...
                    <p data-aos="fade-up" data-aos-duration="3000">
                        초미세먼지, 오존, 이산화질소, 이산화황, 온·습도를 측정하여<br class="pc"> 
                        실시간 대기상태를 전용 모니터링 웹 서비스를 통해 제공 
                    </p>
                    <dl class="order">
                ...
                <div class="point oa_100">
                    ...
                    <dl>
                        <dt data-aos="fade-right" data-aos-easing="ease-in-sine"><img src="/assets/images/OA100.png" alt=""></dt>
                        <dd data-aos="fade-left" data-aos-easing="ease-in-sine">
                            <div class="list3_text_box">
                                <p>환경부 미세먼지 간이측정기 성능인증 1등급(제 KTR-2021-06호)</p>
                                <p>환경부 녹색기술 인증(인증번호 : 제 GT-22-01507호)</p>
                                <p>환경부 녹색기술제품 확인(확인번호: 제 GTP-23-03340호)</p>
                                <ul>
                                    <li>• KC 전자파 적합 등록(등록번호 : R-R-iAR-OA100)</li>
	...
	<div class="sub_wrap">
        ...
        <div class="table_box">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>제품 크기</td>
                        <td>측정부 : H220mm, Ø200mm<br>
                            전원부 : H200mm, W100mm</td>
                    </tr>
                    <tr>
                        <td>제품 중량</td>
                        <td>< 2,500g</td>
        ...
        <div class="pro_common num3">
			...
			<?php
			$_l = $dbo->fetch_list("SELECT * FROM RT_RTBOARD_NORM WHERE bcode='review' AND pdt_model='OA100' AND auth_en='y' ORDER BY seq DESC LIMIT 16");
