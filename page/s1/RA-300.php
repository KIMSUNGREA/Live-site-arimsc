<?php include "../../_head.php"; ?>
        <section class="cont1">
            <div class="sub_wrap">
                <div class="tit_box" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                    <h2>환경부 성능 인증 1등급</h2>
                    <p>ArimAir <b>RA300</b></p>
                </div>
                <figure class="fig_box">
                    <img src="/assets/images/RA_300.png" class="img_ab ra_201 pc" alt="">
                    <img src="/assets/images/RA_300_ch.png" class="mob" alt="">
                </figure>
                <ul class="epl pc" data-aos="fade-up" data-aos-duration="3000">
                    ...
                    <li>제품 전면 디스플레이에서 실시간 측정데이터와 시간 표시</li>
                ...
                <div class="item_btn">
                    ...
                    <button class="buy" onclick="window.open('https://smartstore.naver.com/arimair_/products/8430127904');">제품 구매하기</button>
                </div>
            </div>
        </section>
        <section class="cont2">
            <div class="sub_wrap">
                <ul class="tit_list">
					...
					<?php
					$_t = $dbo->fetch("SELECT COUNT(seq) AS cnt FROM RT_RTBOARD_NORM WHERE bcode='review' AND pdt_model='RA300' AND auth_en='y'");
					?>
                    <li>
        ...
        <section class="cont3">
            <div class="sub_wrap no_padding">
                <div class="item_img_box">
                    <figure>
                        <img src="/assets/images/RA_300_sub.png" alt="">
                    </figure>
                    <figcaption>
                ...
                <div class="item_spec">
                    <img src="/assets/images/RA_300_s.png" alt="" data-aos="fade-up" data-aos-duration="3000">
                    <h4 data-aos="fade-up" data-aos-duration="3000" data-aos-delay="500">ArimAir <b>RA300</b></h4>
		...
		<div class="sub_wrap">
                <div class="point">
                    ...
                    <p data-aos="fade-up" data-aos-duration="3000">
                        RA300은 <b>라돈, 초미세먼지, VOCs, 이산화탄소,</b> 온·습도까지<br class="pc"> 
                        6가지 실내 공기 정보를 동시에 측정하는 실내용 측정기 입니다. 
                    </p>
                    <dl>
                        <dt data-aos="fade-right" data-aos-easing="ease-in-sine"><img src="/assets/images/RA_list1.png" alt=""></dt>
                ...
                <div class="point">
                    ...
                    <p data-aos="fade-up" data-aos-duration="3000">
                        기기 전면 디스플레이와 아림에어 전용 모바일앱을 통해 실내 공기질 측정 결과를<br class="pc"> 
                        ...
                        <dd data-aos="fade-left" data-aos-easing="ease-in-sine">
                            <dl>
                                <dd>
                                    <h5>01. 실시간 공기질 확인</h5>
                                    <span>
                                        전면 디스플레이와 아림에어 전용 모바일앱을 통해<br class="pc">
                                        24시간 언제, 어디서나 간편하게 유해물질 정보를 확인할수 있습니다.
                                    </span>
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <dl>
                                <dd>
                                    ...
                                    <span>
                                        아림에어 전용 모바일 앱으로 설치한 공간의 실시간 공기질 수치는<br class="pc">
                                        물론이고 일간, 주간, 월간 과거 기록을 확인할 수 있습니다. 
                                    </span>
                                </dd>
                            </dl>
                        </dd>
                ...
                <div class="point">
                    ...
                    <dl>
                        <dt data-aos="fade-right" data-aos-easing="ease-in-sine"><img src="/assets/images/RA_list3.png" alt=""></dt>
                        <dd data-aos="fade-left" data-aos-easing="ease-in-sine">
                            <div class="list3_text_box">
                                <p>환경부 라돈 간이측정기 성능인증 1등급(제 PIA-02-2023-4호)</p>
                                <p>환경부 미세먼지 간이측정기 성능인증 1등급(제 KTR-2021-46호)</p>
                                <p>환경부 이산화탄소 간이측정기 성능인증 1등급(제 PIA-01-2023-33호)</p>
                                <ul>
                                    <li>• 환경부 녹색기술 인증(인증번호 : 제 GT-22-01507호)</li>
                                    <li>• 환경부 녹색기술제품 확인(확인번호: 제 GTP-23-03751호)</li>
                                    <li>• KC 전자파적합등록(등록번호 : R-R-iAR-RA300W)</li>
                                    <li>• 품질인증(Q-마크) 지정 제품(KTC, R74-2021-001)</li>
                                    <li>• 라돈, 초미세먼지 포함 실내 공기질 6종 실시간 측정</li>
                                    <li>• 전면 디스플레이로 실시간 측정데이터, 시계 표시</li>
                ...
                <div class="point m_b">
                    ...
                    <p data-aos="fade-up" data-aos-duration="3000">
                        모던한 디자인으로 거실, 침실, 아이방 등 어느 공간에 두어도 어울립니다.
                    </p>
                    <dl data-aos="fade-up" data-aos-duration="3000">
                        <dt><img src="/assets/images/RA_list4.png" alt=""></dt>
                    </dl>
                </div>
            </div>
        </section>
	...
	<div class="sub_wrap">
        ...
        <div class="sub_wrap">
			...
			<?php
			$_l = $dbo->fetch_list("SELECT * FROM RT_RTBOARD_NORM WHERE bcode='review' AND pdt_model='RA300' AND auth_en='y' ORDER BY seq DESC LIMIT 16");
			for ($i = 0; $i < count($_l); $i++) {
				...
				<?php
					...
					<!-- <a href="/page/s2/sub_photo_reivew.php?ct=포토후기">+더 보기</a> -->
				<?php if ($_t['cnt'] > 0) {?>
