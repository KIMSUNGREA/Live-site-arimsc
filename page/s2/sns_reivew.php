        ...
        <section class="cont1">
            <div class="sub_wrap">
                ...
                <ul class="sub_menu_list">
                    <li>
                        <a href="best_review.php">베스트후기</a>
                    </li>
                    <li>
                        <a href="sub_photo_reivew.php?ct=포토후기">포토후기</a>
                    </li>
                    <li>
                        <a href="sns_reivew.php?ct=SNS후기" class="on">SNS후기</a>
                    </li>
		    <li>
        ...
        <section class="sub_main_cont">
            <div class="sub_wrap">
                ...
                <div class="com_reivew_list">
					<?php if ($_GET['cf'] != "form") { ?>
					<a href="/page/s2/sns_reivew.php?ct=SNS후기&cf=form&screen=pc" class="review_btn">SNS후기 쓰기</a>
					<?php } ?>
                    <div class="tit">
                        <h4>SNS 후기</h4>
                    </div>
