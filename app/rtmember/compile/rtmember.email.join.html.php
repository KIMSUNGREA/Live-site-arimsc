<?php /* Template_ 2.2.8 2023/11/09 03:04:20 /www_root/app/rtmember/template/rtmember.email.join.html 000002308 */ ?>
<meta charset="utf-8" />
...
<tr>
	<td style="padding: 50px 0 100px 0;">
		...
		<tr>
			...
			<span style="font-weight:bold; font-size:18px; line-height:180% ">[문의사항]</span><br />서비스 이용에 문의가 있으신 경우 <a href="#none">arimsc@arimsc.com</a>로 보내주시면 순차적으로 처리해드리겠습니다.</td>
		</tr>
		</tbody>
		</table>
	</td>
