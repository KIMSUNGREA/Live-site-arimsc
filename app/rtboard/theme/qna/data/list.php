...
<div class="rt_search_wrap rt_tar">
	<div class="rt_button_wrap rt_fll">
		...
		<a href="/app/rtboard/theme/qna/data/excel.php" class="rt_btn_blue btn_s" target="rt_ifrm">미지급 엑셀다운</a>
	</div>
	<select name="search">
...
<table class="rt_list_table">
	...
	<tbody>
		...
		<tr>
			...
			<?}?>
			<td><p><?php echo ($_l[$i]['give_en']=="y")?"<span class='rt_blue'>완료</span>":"대기";?></td>
			<td class="rt_tal">
				<p>
