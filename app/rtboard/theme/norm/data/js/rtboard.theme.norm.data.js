...
function select_status(div) {

	var form = document.status_form;
	var seqstr = "";
	var cnt = 0;
	...
	if (cnt < 1) {
		alert("상태를 변경할 게시물을 한 개 이상 선택해 주세요");
	} else {
		if (confirm("선택한 게시물의 상태를 변경하시겠습니까?")) {
			form.div.value = div;
