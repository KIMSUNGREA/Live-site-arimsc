<?php /* Template_ 2.2.8 2017/03/11 00:47:03 /home/admin2.co.kr/arim/app/rtboard/template/qna.layout.reponsive.list.html 000008760 */ 
...
<?php }?>
	...
	<div class="rt-button rt-button-tar">
		<a href="<?php echo $TPL_VAR["쓰기페이지링크"]?>" style="cursor: pointer;">문의하기</a>
	</div>
	<!-- 버튼 끝 -->
</div>
<!-- 반응형 게시판 끝 -->
